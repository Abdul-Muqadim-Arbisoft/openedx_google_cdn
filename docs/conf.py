...
"""
openedx_google_cdn documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx_google_cdn',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/openedx_google_cdn",
...
#
# html_title = 'openedx_google_cdn v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_google_cdn'),
                os.path.join(root_path, 'openedx_google_cdn/migrations')])
