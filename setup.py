#!/usr/bin/env python
"""
Package metadata for openedx_google_cdn.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_google_cdn', '__init__.py')
...
setup(
    ...
    url='https://github.com/openedx/openedx_google_cdn',
    packages=find_packages(
        include=['openedx_google_cdn', 'openedx_google_cdn.*'],
        exclude=["*tests"],
    ),
    entry_points={
        "lms.djangoapp": [
            "openedx_google_cdn = openedx_google_cdn.apps:OpenedxGoogleCdnConfig",
        ],"cms.djangoapp": [
             "openedx_google_cdn = openedx_google_cdn.apps:OpenedxGoogleCdnConfig",
        ]
    }
