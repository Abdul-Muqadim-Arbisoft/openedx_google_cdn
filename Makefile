...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd openedx_google_cdn && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd openedx_google_cdn && i18n_tool generate

detect_changed_source_translations:
	cd openedx_google_cdn && i18n_tool changed
...
pull_translations:
	find openedx_google_cdn/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/openedx_google_cdn/openedx_google_cdn/conf/locale:openedx_google_cdn/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd openedx_google_cdn && i18n_tool dummy
